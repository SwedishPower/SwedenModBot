module.exports = {
    ...
    <div id="scroll"style="width: 550px; height: 350px; overflow-y: scroll;">
      ...
      <div>
        <div style="float: left; width: 100%">
          File Path:<br>
          <textarea id="filepath" placeholder="Example Path = ./logs/date/example-date" class="round" style="width: 99%; resize: none; padding: 4px 8px;" type="textarea" rows="1" cols="60"></textarea><br>
        </div><br>
        <div style="float: left; width: 100%;">
          Input Text:<br>
          <textarea id="input" placeholder="Leave Blank For None." class="round" style="width: 99%; resize: 1; padding: 4px 8px;" type="textarea" rows="8" cols="35"></textarea><br>
        </div>
      </div>
    </div>`
  },
  ...
  action: function (cache) {
    ...
    switch (task) {
      case 0: // Create File
        result = () => fs.writeFileSync(fpath, "");
        break;
          
      case 1: // Write File
        result = () => fs.writeFileSync(fpath, itext);
        break;
